...
/**
 * Fetches a layer's filtered extent using WPS gs:Bounds as the primary method,
 * falling back to WFS GetFeature + turf bbox if WPS is unavailable or fails.
 * Returns an Observable emitting `[minx, miny, maxx, maxy]` in EPSG:4326.
...
function applyInteractionEffectForZoomTo(interaction, filterWidget, state, targetContainer = 'floating') {
    ...
    // Fetch extents for all layers concurrently; individual failures yield null
